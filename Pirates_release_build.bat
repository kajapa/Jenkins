...
if %commit_day% GEQ 10 (
    set "commit_day=%commit_day%"
) else (
    set "commit_day=0%commit_day%"
)
...
set "path=%commit_date%_%commit_hash_short%_r"
...
"C:\Program Files\Unity\Hub\Editor\2021.3.23f1\Editor\Unity.exe" -batchmode -quit -projectPath "%repo_path%" -buildPath "%full_path%" -executeMethod BuildingTool.BuildScript.BuildWindows
