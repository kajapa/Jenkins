...
pipeline{
    ...
    label {
        ...
        customWorkspace "D:/Jenkins/Workspace/SHS/"
        }
    }
    environment {
        ...
        def commit_file = 'D:/Jenkins/Workspace/SHS_commit_id.txt'
   ...
   stage('Build') {
    ...
    steps {
      script{
         ...
         if (checkout_clean =='Yes'){
        bat """
"D:/Program Files/Epic Games/UE_5.3/Engine/Build/BatchFiles/RunUAT.bat" BuildCookRun -rocket -clean -pak -compile -nocompileeditor -installed -project="D:/Jenkins/Workspace/SHS/StorageHunter/StorageHunter.uproject" -nop4 -utf8output -compileeditor -buildmachine -platform=Win64 -targetplatform=Win64 -clientconfig="${env.build_conf}" -build -cook -stage -verbose -NoSign -NoCodeSign -stagingdirectory="${folder_name}" -log="D:/Jenkins/Workspace/SHS/Logs/SHS_Log.txt"
"""     
         }else if (checkout_clean =='No'){
         bat """
"D:/Program Files/Epic Games/UE_5.3/Engine/Build/BatchFiles/RunUAT.bat" BuildCookRun -rocket -pak -compile -nocompileeditor -installed -project="D:/Jenkins/Workspace/SHS/StorageHunter/StorageHunter.uproject" -nop4 -utf8output -compileeditor -buildmachine -platform=Win64 -targetplatform=Win64 -clientconfig="${env.build_conf}" -build -cook -stage -verbose -NoSign -NoCodeSign -stagingdirectory="${folder_name}" -log="D:/Jenkins/Workspace/SHS/Logs/SHS_Log.txt"
"""
}
